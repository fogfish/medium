...
require (
	...
	github.com/aws/aws-cdk-go/awscdk/v2 v2.200.1
	...
	github.com/fogfish/swarm/broker/eventbridge v0.22.2
...
require (
	...
	github.com/cdklabs/awscdk-asset-awscli-go/awscliv1/v2 v2.2.239 // indirect

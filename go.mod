...
require (
	...
	github.com/fogfish/swarm/broker/eventbridge v0.24.0
	github.com/fogfish/swarm/broker/events3 v0.24.0
...
require (
	...
	github.com/cdklabs/awscdk-asset-awscli-go/awscliv1/v2 v2.2.245 // indirect
